...
# my suggestion to you would be to add the breaks argument, this will allow you to define the number of bins you want, therefore adding breaks = 30 should give you 30 bins similar to the one in the histogram before
# otherwise your code looks very good, the graphs are "pretty"as in they are well labeled in addition your annotations are easy to follow 
```
>5 Challenges
